 ...
 * @deprecated Use ExpandableGrid component instead
 */
...
/**
 * Hook for width/height animations
...
export function useExpandAnimation<T extends HTMLElement>(
  ...
  }, [isExpanded, expandedWidth, collapsedWidth, expandedHeight, collapsedHeight, duration, ease, includeOpacity]);
